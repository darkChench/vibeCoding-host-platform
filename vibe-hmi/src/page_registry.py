...
class PageMeta:
    ...
    icon: str             # 图标符号（Unicode 字符，原型用 ▣↔▥◎⚙!◇i✦）
...
PAGES: list[PageMeta] = [
    # === 设备 ===
    PageMeta("overview",    "设备总览", "▣", "设备", "3", "ok"),
    PageMeta("serial",      "串口连接", "↔", "设备", "COM3", "ok"),
    PageMeta("monitor",     "实时监控", "▥", "设备", "2 点"),
    PageMeta("statusPolicy","状态策略", "◎", "设备", "10 min"),
    PageMeta("params",      "参数配置", "⚙", "设备", "已同步"),
    # === 数据 ===
    PageMeta("alarms",      "报警记录", "!", "数据", "1", "warn"),
    PageMeta("history",     "历史数据", "◇", "数据", "CSV"),
    PageMeta("settings",    "系统设置", "i", "数据", "v0.1"),
    # === AI ===
    PageMeta("aiAssistant", "AI 助手",  "✦", "AI", "对话"),
    PageMeta("modelConfig", "模型配置", "⚙", "AI", "设置"),
]
